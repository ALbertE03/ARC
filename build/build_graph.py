...
class ModelPerformanceTracker:
    ...
    def save_performance(self, filename='./model/model_performance.pkl'):
        with open(filename, 'wb') as f:
            pickle.dump(self.get_performance_stats(), f)
            
    @staticmethod
    def load_performance(filename='./model/model_performance.pkl'):
        try:
...
if __name__ == "__main__":
    ...
    graph.save_graph('./model/author_collaboration_graph.graphml')
